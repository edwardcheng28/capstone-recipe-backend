...
user1 = User.create!(name: "Edward Cheng", email: "echeng@email.com", password_digest: "password", image_url: "https://images.pexels.com/photos/3877832/pexels-photo-3877832.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")
